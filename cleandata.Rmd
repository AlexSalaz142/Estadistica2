...
datafinal=merge(dataN,dataM, by.x="country", by.y="country", all.x=T)
```
Descartar NAs
```{r}
...
```{r}
write.csv(datafinal,"C:\\Users\\Gianfranco\\Documents\\GitHub\\TrabajoE2\\datafinal.csv", row.names = FALSE)
```
